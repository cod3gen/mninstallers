...
USER=pushiuser
TEMPDIR=tempPUSHI
COINGIT="https://github.com/pushiplay/pushi.git"
COINGITSENTINEL="https://github.com/pushiplay/sentinel.git"
COIN=PUSHI
COIND=pushid
COINDS=pushid_screen
COINCLI=pushi-cli
COINCONF=pushi.conf
COINCORE=.pushicore
COINS="PUSHI:"
COINDEV="PEdQJ4SnkHk86XpRhhKviJoksbuMKpL7qg"
ADDCOINCONF=""
